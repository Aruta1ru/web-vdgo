# Generated by Django 3.0.10 on 2021-11-30 12:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Администратор'), ('boss', 'Руководитель'), ('user', 'Пользователь')], default='user', max_length=9, verbose_name='Роль')),
                ('executor', models.ForeignKey(db_column='id_exec', default=0, on_delete=django.db.models.deletion.PROTECT, to='account.Executor', verbose_name='Исполнитель')),
